...
public class SortSetTest {
    ...
    private static SortSet _sorted;
    @Before
    ...
    public void Test_ElementsAreSorted() {
        ...
        _expected.add("Harry");
        _expected.add("Olive");
        assertEquals("Expected list Doesn't matching with actual array",_expected,_sorted.sortSetAndReturnArrayList(_actual));
        _actual.clear();
        _expected.clear();
    ...
    public void Test_ElementsAreSorted_failure() {
        HashSet<String> _actual=new HashSet<>();
        assertNull("Expected list Doesn't matching with actual array",_sorted.sortSetAndReturnArrayList(_actual));
    }
}